...
KERNEL=="hidraw*", ATTRS{idVendor}=="18d1", ATTRS{idProduct}=="9400", TAG+="uaccess"    
  ...
  # services.tlp.enable = lib.mkIf (config.services.power-profiles-daemon == false) true;
  ...
  nix.settings = {
    substituters = ["https://hyprland.cachix.org" "https://nix-community.cachix.org" "https://helix.cachix.org" "https://nix-gaming.cachix.org" "https://eigenvalue.cachix.org"];
    trusted-public-keys = ["hyprland.cachix.org-1:a7pgxzMz7+chwVL3/pzj6jIBMioiJM7ypFP8PwtkuGc=" "helix.cachix.org-1:ejp9KQpR1FBI2onstMQ34yogDm4OgU2ru6lIwPvuCVs=" "nix-gaming.cachix.org-1:nbjlureqMbRAxR1gJ/f3hxemL9svXaZF/Ees8vCUUs4=" "nix-community.cachix.org-1:mB9FSh9qf2dCimDSUo8Zy7bkq5CX+/rkCWyvRCYg3Fs=" "eigenvalue.cachix.org-1:ykerQDDa55PGxU25CETy9wF6uVDpadGGXYrFNJA3TUs="];
  };
  ...
  users.users.basilk = {
    isNormalUser = true;
    extraGroups = ["wheel" "networkmanager" "render" "video" "dialout" "realtime" "audio" "libvirtd"];
    packages = with pkgs; [
      firefox
      tree
    ];
  ...
  environment.systemPackages = [pkgs.firefox-devedition-bin pkgs.home-manager pkgs.comma pkgs.vulkan-validation-layers pkgs.libva-utils pkgs.virt-manager pkgs.wineasio pkgs.wineWowPackages.waylandFull pkgs.winetricks pkgs.alsa-plugins pkgs.alsa-tools pkgs.wl-clipboard pkgs.ffmpeg] ++ pkgs.cosmic-de;
